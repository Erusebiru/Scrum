...
<?php
	...
	if(isset($_SESSION['user'])){
		...
		mail($email,"Recuperar Contraseña","Ve a la pagina siguiente para cambiar la contraseña de tu usuario: http://35.174.228.251/Scrum/cambiarPassword.php?token=".$token,"from: ubuntu@blablaslba.com");
